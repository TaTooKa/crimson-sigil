...
⋗ **When you suffer the outcome of a mechanical or narrative <span class="secondary">FAILURE</span>.**
...
[ADVANCE YOUR CHARACTER ARC](/prompts/fate-prompts#advance-your-character-arc)<br/>⋗ **When you discover or exhaustively explore a new region, wilderness incursion or perilous location**, or<br/>⋗ **When you acquire a new contact, make a new friendship with an individual or a group, or significantly develop your relationship with an ally or a community**, or<br/>⋗ **When you deal with your PERSONAL QUEST, discover clues related to it, or advance towards fulfilling its goal**.
