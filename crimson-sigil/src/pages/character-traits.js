...
import Stat from '/src/@rocketseat/gatsby-theme-docs/components/Stat'
      ...
      <form class="character-traits">
        ...
        <div class="traits-container" id="general-traits-container">
            ...
            <Trait name="Bloodletter" title="BLOODLETTER" art={placeholder_art} inputs={inputs} handleChange={handleChange}>
              <span>You know of many techniques to heal and provide treatment. You gain a <span class="boost">BOOST</span> when you <a href="/prompts/recovery-prompts#heal">HEAL</a> others with your <span class="stat">WITS</span> (alternatively, they gain a <span class="boost">BOOST</span> if they receive treatment from you by testing their <span class="stat">MIGHT</span>), and if successful, they recover <b>+1 GRIT</b>.</span>
            </Trait>
        ...
        <div class="traits-container" id="prestige-traits-container">
            ...
            <Trait name="Branded" title="BRANDED" art={placeholder_art} inputs={inputs} handleChange={handleChange}>
              <span>You have been branded by some powerful demonic entity. You can sense the presence of nearby evil, and it can sense you. You gain a <span class="boost">BOOST</span> for any action related to dealing directly with demons or other fiends, but at the end of that dramatic situation you must <a href="/prompts/suffer-prompts#endure-harm">ENDURE serious HARM</a> or <a href="/prompts/suffer-prompts#endure-stress">STRESS</a> (your choice), because of the physical or spiritual pain your brand instills.</span>
              <br/><br/><hr/><br/>
            ...
            <Trait name="Commander" title="COMMANDER" art={placeholder_art} inputs={inputs} handleChange={handleChange}>
              <span>You are a natural leader. Gain a <span class="boost">BOOST</span> whenever you test your <span class="stat">WITS</span> or <span class="stat">CHARM</span> to command others or further your objectives from a ruling position. Additionally, if you lose <b>-1 WILL</b> and give an order (verbal or gesticulated) to your allies, they all gain a <span class="boost">BOOST</span> for their next action.  </span>
              <br/><br/><hr/><br/>
            ...
            <Trait name="Conqueror" title="CONQUEROR" art={placeholder_art} inputs={inputs} handleChange={handleChange}>
              <span>You are a battlemaster, a subjugator and a large-scale strategist. You gain a <span class="boost">BOOST</span> to any action related to commanding large groups of people against an enemy, or in endeavors related to the politics of war. Additionally, when you are in battle, you gain a <span class="boost">BOOST</span> when you <a href="/prompts/general-prompts#act-under-pressure">ACT UNDER PRESSURE</a> or <a href="/prompts/general-prompts#secure-an-advantage">SECURE AN ADVANTAGE</a> with <span class="stat">WITS</span> or <span class="stat">GUILE</span>.</span>
              <br/><br/><hr/><br/>
            ...
            <Trait name="HybridGuardian" title="HYBRID GUARDIAN" art={placeholder_art} inputs={inputs} handleChange={handleChange}>
              <span>You belong to a secretive order of guardians that, in order to protect mankind, mutate themselves into fiendish hybrids. You can use demonic powers and even temporarily reshape parts of your body, which gives a <span class="boost">BOOST</span> to any action at the cost of losing <b>-1 WILL</b> each time. At the end of the fray, or when you decide to return back to normal, you must <a href="/prompts/suffer-prompts#endure-stress">ENDURE serious STRESS</a> with a <span class="setback">SETBACK</span> to avoid the temptation of succumbing and transforming into that which you’ve sworn to fight.</span>
              <br/><br/><hr/><br/>
            ...
            <Trait name="Magus" title="MAGUS" art={placeholder_art} inputs={inputs} handleChange={handleChange}>
              <span>You are a powerful sorcerer, a force to be reckoned with. Gain a <span class="boost">BOOST</span> whenever you test your <span class="stat">WITS</span> or <span class="stat">HASTE</span> to produce a powerful magical effect for any action, but lose <b>-1 WILL</b> each time.</span>
              <br/><br/><hr/><br/>
            ...
            <Trait name="Paladin" title="PALADIN" art={placeholder_art} inputs={inputs} handleChange={handleChange}>
              <span>You are the champion of your faith. You can lose <b>-1 WILL</b> to gain a <span class="boost">BOOST</span> to any action in which you channel the energy of holy radiance and purity. Additionally, you gain a <span class="boost">BOOST</span> for any attempt to <a href="/prompts/general-prompts#gather-information">GATHER INFORMATION</a> or <a href="/prompts/general-prompts#compel">COMPEL</a> against an individual that might respect or admire your cause.</span>
              <br/><br/><hr/><br/>
            ...
            <Trait name="Wildwarden" title="WILDWARDEN" art={placeholder_art} inputs={inputs} handleChange={handleChange}>
              <span>Your domain is a region of wilderness that you know like the palm of your hand. You can sense when anything out of the ordinary happens there, and whenever you are in its premises, you gain a <span class="boost">BOOST</span> to any action. Additionally, you provide a <span class="boost">BOOST</span> to any ally that attempts to <a href="/prompts/recovery-prompts#heal">HEAL</a>, <a href="/prompts/recovery-prompts#relax">RELAX</a> or <a href="/prompts/recovery-prompts#resupply">RESUPPLY</a> in the area with your blessing.</span>
              <br/><br/><hr/><br/>
