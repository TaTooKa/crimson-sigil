...
&nbsp;<span class="primary bold">⋙ SUCCESS</span>: You successfully fulfill your ANGLE.
...
&nbsp;<span class="secondary bold">⋙ FAILURE</span>: You utterly fail at achieving your ANGLE.
